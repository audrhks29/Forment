  ...
  fetchData: async () => {
    try {
      const [optionDataResponse, setDataResponse, detailImageResponse] = await Promise.all([
        ...
        axios.get('https://gist.githubusercontent.com/audrhks29/caa13ccf491746f824fe181d779aed55/raw/46369bfe2df91393e1b19a2263c40db55f9c6957/productDetailImageData.json')
      ]);
